...
Python 3.8 or higher is required. MacOS X and recent Linux distributions should have Python 3 preinstalled. If not, you can install Python 3.8+ from your package manager or from python.org.
