...
Python 3.8 or higher is required. MacOS X and recent Linux distributions should have Python 3 preinstalled. If not, you can install it from python.org or your system's package manager.
